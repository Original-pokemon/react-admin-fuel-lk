...
export const generateMockFuelCardData = (): FuelCardType => {
  return {
    ...
    monthLimit: faker.datatype.float({ min: 0, max: 10_000 }),
    monthRemain: faker.datatype.float({ min: 0, max: 10_000 }),
    ...
    longUpdate: faker.datatype.bigInt({
      min: 100_000_000_000_000,
      max: 999_999_999_999_999,
    }),
    specUpdCur: faker.datatype.bigInt({
      min: 100_000_000_000_000,
      max: 999_999_999_999_999,
    }),
